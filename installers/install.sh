...
then
    curl -o non-root.py https://cdn.gitmirror.com/gh/Ilya114/Box64Droid/main/installers/non-root.py && python3 non-root.py
elif [ $version = 2 ]
then
    curl -o root.py https://cdn.gitmirror.com/gh/Ilya114/Box64Droid/main/installers/root.py && python3 root.py
elif [ $version = 3 ]
then
    curl -o virgl.py https://cdn.gitmirror.com/gh/Ilya114/Box64Droid/main/installers/virgl.py && python3 virgl.py
elif [ $version = 4 ]
then
    curl -o native.py https://cdn.gitmirror.com/gh/Ilya114/Box64Droid/main/installers/native.py && python3 native.py
elif [ $version = 5 ]
then
    rm install
    exit
